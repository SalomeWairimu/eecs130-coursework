...
const playGame = () => {
    ...
    var comp_icon = '<i class="fa fa-hand-rock-o"></i>';
    if (computerChoice === "scissors")
    {
        comp_icon = '<i class="fa fa-hand-scissors-o"></i>';
    }
    else if (computerChoice === "paper")
    {
        comp_icon = '<i class="fa fa-hand-paper-o"></i>';
    }
    document.querySelector('.computer-choice').innerHTML = 'Computer Choice :' + comp_icon;
    var user_icon = '<i class="fa fa-hand-rock-o"></i>';
    if (userChoice === "scissors")
    {
        user_icon = '<i class="fa fa-hand-scissors-o"></i>';
    }
    else if (userChoice === "paper")
    {
        user_icon = '<i class="fa fa-hand-paper-o"></i>';
    }
    document.querySelector('.user-choice').innerHTML = 'User Choice: ' + user_icon;
